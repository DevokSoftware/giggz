...
import com.devok.giggz.openapi.model.EventComedianResponse;
...
public interface ComedianApiMapper {
    ...
    EventComedianResponse toEventComedianResponse(ComedianDTO comedian);
    List<EventComedianResponse> toEventComedianResponseList(List<ComedianDTO> comedian);
}
